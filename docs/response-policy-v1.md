...
| `enterprise_qa` | 企业、公司、产品、服务、价格、合作、联系方式等 | 75 | 超长时追加“要我继续介绍哪一项？” |
| `explain` | 为什么、如何、方案、步骤、知识库等 | 90 | 超长时追加“要我继续说明吗？” |
...
LATENCY event=response_policy trace=... policy=enterprise_qa max_chars=75 suffix=True
```
